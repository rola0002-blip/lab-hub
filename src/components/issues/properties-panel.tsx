      ...
      <div className="py-1.5">
        ...
        <div className="mt-1">
          <LabelPicker labels={labels} selectedIds={issue.labels.map((l) => l.id)} canEdit={canEdit}
            onChange={(next) => start(() => setLabelsAction(issue.id, next).then(() => {}))} />
        </div>
      </div>
    </aside>
  )
