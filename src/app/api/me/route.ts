...
import {
  setThemePreference, setAccentPreference, setSoundsPreference, setName, setTitle, setTimezone,
...
export async function PATCH(req: Request) {
  ...
  const { themePreference, accentPreference, soundsEnabled, name, title, timezone } = parsed.data
  ...
  if (soundsEnabled !== undefined) await setSoundsPreference(user.id, soundsEnabled)
